...
const Footer = () => {
    return (
		<>
			<div className={(window.innerWidth >= 770 ? "mx-5" : "") + " footer text-center bg-dark text-white mt-5"}>
				<div className="row justify-content-center">
					<div className="mission-footer col-sm-6 col-md-4 my-4 px-5 py-3 border border-white border-top-0 border-bottom-0 border-left-0">
					...
					<div className="col-sm-6 col-md-4 p-1 my-4 border border-white border-top-0 border-bottom-0 border-left-0 justify-content-around">
						<div className="row">
							<div className='mission-footer col-md-6'>
								<h4>Genres</h4>
					...
					<div className="mission-footer col-sm-6 col-md-4 my-4">
						<h1>Contact Us</h1>
						<div>
