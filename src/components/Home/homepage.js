        ...
        <div className="container">
            <div className="">
                <div className="jumbotron home-jumbo mt-5 pt-5 d-flex flex-wrap bg-medium">
                    <div className="col-12 col-lg-6">
                        <img className="featured-jumbo" src="https://m.media-amazon.com/images/M/MV5BNjNjMTdkNjUtNzRmNi00ZTZjLTgzMDUtNzBhNTVmODUwM2QxXkEyXkFqcGdeQWFybm8@._V1_.jpg" />
                    </div>
                    <div className="col-12 col-lg-6" >
                        <h1 className="display-5 pt-5 text-black">Mortal Kombat</h1>
                        <p className="lead text-black">Steven, JP and John pontificate about this year's indie gem, <i>Mortal Kombat</i>.<br /><a href='https://podcasts.apple.com/us/podcast/inside-the-backlot/id1460214563?i=1000519515819'>Listen on Apple Podcasts</a><br /><a href='https://open.spotify.com/episode/5VvfYv5Bzm6BveQcMMz0cJ?si=a55e060313984fef'>Listen on Spotify</a></p>
                    </div>
                </div>
            </div>
            ...
            <CardDeck className="podcasts pb-5">
                <Card className='podcast-card'>
                    <Card.Img variant="top" src="https://zambiainc.com/wp-content/uploads/2021/04/Mortal-Kombat.jpg" />
